...
- 支持数据库版 (DbSkillSystem) 和文件系统版 (SkillSystem, 已废弃) 两种加载方式
- `read_reference` 工具支持按需读取技能目录下的参考文件

### 并发治理
- 分层队列 (APIQueue): `llm`、`embedding`、`rerank` 分 lane 控制并发
